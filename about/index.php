...
<div class="p-5" > 
    <button class="my-5" style="background-color: black;" ><a href="../" style="text-decoration: none; color: rgb(225, 220, 220);" >🔙Go Back</a></button>

 <h1 style="  color: rgb(225, 220, 220);" > Hi, I&#39;m Ace Jimbo, </h1>
 <p style="color: rgb(225, 220, 220);">I stream Escape From Tarkov 5 days a week and wanted to create a website that can help new and veteran players. </p>

<p  style="color: rgb(225, 220, 220);">Thats why Tarkovtracker.ca was created. I really like playing video games and learn stuff about business world.</p>
</div>
</body>
</html>